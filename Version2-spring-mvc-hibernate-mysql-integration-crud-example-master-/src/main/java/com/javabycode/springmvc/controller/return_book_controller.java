...
@RequestMapping("/return_book_home.html")
@Controller
public class return_book_controller {
	...
	public String showUser(Map model) {
		...
		return "return_book_home";
	}
	
	
	@RequestMapping(method = RequestMethod.POST)
	public String return_book(@RequestParam("user_ID") int user_ID,
			@RequestParam("book_ID") int book_ID,@RequestParam("date_of_return") String date_of_return,
		...
		String  Date_of_return_get=date_of_return;
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
		Date date_of_return1 = sdf.parse(Date_of_return_get);
		...
		if(availability == false)
		{
			...
			if(Book_ID==book1_id)
			{
				...
				try
				{
				long diffrence= date_of_return1.getTime()-book1_issue.getTime();
				...
				model.addAttribute("book_id", book1_id);
				model.addAttribute("book_issue", book1_issue);
				model.addAttribute("book_return", date_of_return1);
				model.addAttribute("no_of_days", no_of_days);
				model.addAttribute("fine", fine);
				return "return_book_confirmation";
			}
			else if(Book_ID==book2_id )
			{
				...
				model.addAttribute("User_ID", User_ID);	
				model.addAttribute("user_name", user_name);
				model.addAttribute("book_id", book2_id);
				model.addAttribute("book_name", book_name);
				model.addAttribute("book_issue", book2_issue);
				model.addAttribute("book_return", date_of_return1);
				model.addAttribute("no_of_days", no_of_days);
				model.addAttribute("fine", fine);
			...
			return "return_book_notassigned_to_user";
		}
