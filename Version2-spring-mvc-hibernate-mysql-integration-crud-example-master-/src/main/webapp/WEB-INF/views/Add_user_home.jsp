...
<form:form method="POST" modelAttribute="user_details" action="add_user_home.html">
...
<td>
<form:input type="text" name="Name" path="User_name" id="User_name"/><br>
</td>
</tr>
<tr>
<td>
...
<td>
<form:input type="text" name= "Address" path="Address" id="Address"/><br>
</td>
</tr>
<tr>
<td></td>
